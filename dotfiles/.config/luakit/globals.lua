...
search_engines = {
    google = "https://www.google.de/search?output=search&sclient=psy-ab&q=%s&oq=&gs_l=&pbx=1",
    git = "https://github.com/search?q=%s&ref=cmdform",
    hoogle = "http://www.haskell.org/hoogle/?hoogle=%s",
    duck = "https://duckduckgo.com/?q=%s",
    wiki = "http://en.wikipedia.org/w/index.php?search=%s&title=Special:Search",
